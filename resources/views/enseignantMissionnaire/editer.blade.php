...
<div class="card shadow mb-4" style="max-width: 800px; margin: auto;">
    <div class="card-body">
        <div class="table-responsive">
            ...
            <form action="{{route('self-editer-enseignant-missionnaire', ['id' => $enseignant->id])}}" method="post">
                @csrf
                ...
                <div class="align-center mt-4">
                    <a href="{{route('home-enseignant-missionnaire', ['id' => $enseignant->id])}}" class="btn btn-outline-danger me-auto" style="float: left;">Annuler</a>
