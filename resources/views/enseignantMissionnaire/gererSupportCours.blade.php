...
@section('contenu')
<h1 class="h3 mb-2 text-gray-800">Liste de vos supports de cours</h1>
<!-- DataTales Example -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: flex;">
                            <form action="{{route('self-enseignant-local-supprimer-cours', ['id' => $enseignant->id, 'idCours' => $sc->id])}}" method="post">
                                @method('delete')
                                @csrf
