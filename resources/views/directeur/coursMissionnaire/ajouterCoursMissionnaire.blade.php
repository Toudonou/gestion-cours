...
<div class="card shadow mb-4" style="max-width: 800px; margin: auto;">
    <div class="card-body">
        <div class="table-responsive">
            <h2 class="center-text mb-4">Ajouter un cours de mission</h2>
            <form action="{{route('ajouter-cours-missionnaire', ['id' => $directeur->id])}}" method="post">
                @csrf
