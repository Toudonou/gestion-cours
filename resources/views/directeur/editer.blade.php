...
<div class="card shadow mb-4" style="max-width: 800px; margin: auto;">
    <div class="card-body">
        <div class="table-responsive">
            <h2 class="center-text mb-4">Editer le directeur</h2>
            <form action="{{route('editer-directeur', ['id' => $directeur->id])}}" method="post">
                @csrf
                <div class="mb-3 form-floating">
                    <input type="text" class="form-control" name="nom" id="nom" placeholder="nom" value="{{$directeur->nom}}" required>
                ...
                <div class="mb-3 form-floating">
                    <input type="text" class="form-control" name="prenom" id="prenom" placeholder="prénoms" value="{{$directeur->prenom}}" required>
                ...
                <div class="mb-3 form-floating">
                    <input type="email" class="form-control" name="email" id="email" placeholder="name@example.com" value="{{$directeur->email}}" required>
                ...
                <div class="align-center mt-4">
                    <a href="{{route('home-directeur', ['id' => $directeur->id])}}" class="btn btn-outline-danger me-auto" style="float: left;">Annuler</a>
