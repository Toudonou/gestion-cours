                            ...
                            <div class="card shadow mb-4" style="max-width: max-content; margin: -100px auto;">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <form action="{{route('self-enseignant-local-upload-cours', ['idEnseignant' => $enseignant->id, 'idCours' => $uc->id])}}" method="post" enctype="multipart/form-data">
                                            @csrf
                            ...
                            <div class="card shadow mb-4" style="max-width: max-content; margin: -100px auto;">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <form action="{{route('self-enseignant-local-upload-td', ['idEnseignant' => $enseignant->id, 'idCours' => $uc->id])}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3 form-floating">
                                                <label for="fichier">Fichier</label>
                                                <input type="file" class="form-control" name="fichier" id="fichier" required>
